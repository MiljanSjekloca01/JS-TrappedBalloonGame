...
heatingSystem = function(entities){  // Moze i u physicsSystem al ako ne budem imao vise sistema ostaviti
    let newEntities = [];
    for(e of entities){
...
systems.push(userInputSystem,collisionSystem,renderingSystem,heatingSystem,physicsSystem);
